...
import {
  Plane, Clock, Search, MapPin, Trash2, PlusCircle, FileText, Star,
  Wind, Eye, Cloud, Gauge, Activity, CloudDrizzle, Signal, AlertTriangle, ChevronDown,
  CloudRain, Waves, RefreshCw, Loader2, LogOut, Key, Sliders, Info, FileWarning
} from 'lucide-react';
